...
# Frame
FRAME_COST_MONEY = 10
# Foundation (généralement coût 0 car initial)
# Generator
...
MACHINE_GUN_COST_IRON = 40
MACHINE_GUN_POWER_CONSUMPTION = 6
MACHINE_GUN_RANGE_PIXELS = 150
...
FLAMETHROWER_COST_IRON = 60
FLAMETHROWER_POWER_CONSUMPTION = 7
FLAMETHROWER_RANGE_PIXELS = 80
FLAMETHROWER_DURATION_SEC = 4.0  # Référencé par STAT_FLAMETHROWER_DURATION_SEC
FLAMETHROWER_COOLDOWN_SEC = 2.0  # Référencé par STAT_FLAMETHROWER_COOLDOWN_SEC
# Sniper
...
BASE_PROJECTILE_SPRITE_SCALE_FACTOR = 0.5 # Facteur de scaling pour la HAUTEUR du sprite projectile par rapport à tile_size
...
BASE_ENEMY_SPAWN_Y_PADDING = 20 # Padding depuis le haut/bas de la zone de jeu utilisable (excluant top_bar et build_menu)
