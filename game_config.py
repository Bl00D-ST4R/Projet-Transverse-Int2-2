...
STAT_SIZE_MIN_SCALE = "dd" # Pour les ennemis (facteur d'échelle)
STAT_SIZE_MAX_SCALE = "eee" # Pour les ennemis (facteur d'échelle)
STAT_HITBOX_SCALE_FACTORS = "gfd" # (width_scale, height_scale) par rapport au rect du sprite
STAT_SIZE_MIN = "eeeee"
STAT_SIZE_MAX = "dfgfdfg"
