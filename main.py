...
def main_application_loop(screen, clock, scaler):
    ...
    ui_functions.initialize_pause_menu_layout(scaler) # <-- APPEL EXISTANT, CONFIRMÉ
    ui_functions.initialize_game_over_layout(scaler)  # <-- APPEL EXISTANT, CONFIRMÉ
...
def run_game():
    ...
    try:
        ...
        # else: if cfg.DEBUG_MODE: print(f"Icône non trouvée: {icon_path}") # Uncomment if needed
